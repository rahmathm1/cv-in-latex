...
\address{Full-stack Developer\\
  Tata Consultancy Services, Cochin, Kerala\\
...
\begin{category}{Technical Skills}
  ...
  \citembullet {\it Frameworks}: Angular 1 \& 2+, VueJS, ReactJS, Spring Boot.
  \citembullet {\it DevOps}: Docker, Kubernetes(AWS EKS), CI/CD.
  \citembullet {\it Operating Systems}: Linux, Mac OSX, Microsoft Windows.
  \citembullet {\it Others}: Redux, Micro-services, SMACSS, Photoshop, Zeplin, Tailwind.
\end{category} 
