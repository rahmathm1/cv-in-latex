...
\begin{category}{Technical Skills}
  ...
  \citembullet {\it Programming Languages}: JavaScript, TypeScript, HTML5, SASS, C\#.Net, Java.
  \citembullet {\it Frameworks}: Angular 1.x - 8, VueJS, Redux(NGRX), ASP.Net, Spring Boot
  \citembullet {\it Databases}: MySQL, MS SQL Server, MongoDB
  \citembullet {\it Tools}: ng-cli, webpack, Photoshop, Zeplin.
