...
\begin{category}{Technical Skills}
  ...
  \citembullet {\it Frameworks}: Angular 1 \& 2, BackboneJS, ExpressJS, jQuery Mobile, PHP Codeigniter - REST Server.
  \citembullet {\it Databases}: MySQL, MS SQL Server.
  \citembullet {\it Tools}: Phonegap CLI, Gulp, webpack, Yeoman, Eclipse, Photoshop, Zeplin.
  \citembullet {\it Version Control}: Git, SVN, TFS.
  \citembullet {\it Specialities}: JavaScript, JS Patterns, HTML5 Mobile Apps, Interested in TDD, Polyglot Programmer.
\end{category} 
