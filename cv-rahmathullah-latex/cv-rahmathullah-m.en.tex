...
\address{Full-stack Developer\\
  IBM (Software Labs), Kochi, Kerala\\
...
\begin{category}{Technical Skills}
  ...
  \citembullet {\it Frameworks}: Angular, VueJS, ReactJS, Vert.x, Spring Boot.
  \citembullet {\it DevOps}: Docker, Kubernetes(AWS EKS), CI/CD.
  \citembullet {\it Operating Systems}: Linux, Mac OSX, Microsoft Windows.
  \citembullet {\it Others}: Redux, Micro-services, SMACSS, Photoshop, CucumberJs, Cypress.
\end{category} 
...
\begin{category}{Work Experience}
  ...
  \citem{IBM - Software Labs}
  \citemnobullet \textbf{Lead Full-stack developer} \hfill \textbf{May 2025 -- present}
  \citemnobullet The India Systems Development Lab (ISDL) is the largest development hub in IBM’s Infrastructure division, which includes the Systems, Cloud and Technology Lifecycle Services (TLS) business units. It was established in 1997 and has development teams in Kochi, Bangalore, Pune and Hyderabad.
  \begin{itemize}
  \item \textbf{Event Endpoint Management} (Event Automation) : IBM Event Endpoint Management (EEM) is designed to manage Kafka topics and event streams across an organization, providing a centralized platform for discovery, access control, and governance. {\em Vert.x, ReactJS}. \textbf{Role}: {\em Lead Full-stack Developer}. 
  \item \textbf{Embedded Streaming} (Event Automation) : IBM Embedded Streaming is a built-in feature of IBM webMethods Hybrid Integration that lets you easily set up channels to send and receive real-time data events. It handles all the complex background infrastructure so you can manage your data streams through a simple interface. {\em Vert.x, ReactJS}. \textbf{Role}: {\em Lead Full-stack Developer}. 
  \end{itemize}


  \citem{Tata Consultancy Services}
  \citemnobullet \textbf{Assistant Consultant} \hfill \textbf{Apr 2018 -- May 2025}
