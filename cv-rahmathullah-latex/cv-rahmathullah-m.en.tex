...
\begin{category}{Technical Skills}
  ...
  \citembullet {\it Programming Languages}: JavaScript, TypeScript, HTML5, SASS, C\# .Net, Java 8.
  \citembullet {\it Frameworks}: Angular 1.x - 8, VueJS, jQuery Mobile, Redux(NGRX).
